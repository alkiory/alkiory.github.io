export const translations = {
  es: {
    ...
    home: {
      ...
      selectedWorksDesc: 'Aquí tienes algunos de mis proyectos destacados.',
      viewAll: 'Ver todo',
      lastBlog: 'Artículos recientes',
      lastBlogDesc: 'Aquí tienes algunos de mis artículos recientes.',
      skills: 'Habilidades',
      fullstack: 'Fullstack',
      ...
      workExperienceDesc: 'He tenido la suerte de trabajar con estas empresas y más.',
      contact: 'Contacto',
  ...
  en: {
    ...
    home: {
      ...
      workExperienceDesc: 'I have been fortunate enough to work with these companies and more.',
